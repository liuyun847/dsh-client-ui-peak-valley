          ...
          return new Promise(function (resolve) {
            ...
            connection.api.sessions
              ...
              .then(function (modelsRes) {
                ...
                // 峰谷价是 DeepSeek 官方定价,模型必须为 DeepSeek 系列。
                if (current === undefined || typeof current.model !== "string" || !current.model.startsWith("deepseek-")) {
                  return false;
                }
                // opencode-go 网关来源:视为官方定价,直接显示(该网关无 baseURL 概念)。
                if (current.provider === OPENCODE_GO_PROVIDER) return true;
